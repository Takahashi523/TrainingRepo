...
- [x] ✅ 2026-06-09 pytest 全件通過（95件）
- [x] ✅ 2026-06-09 カバレッジ90%以上（98% 達成）
- [x] ✅ 2026-06-09 `SELECT *` が存在しないこと（コメント行のみ・実SQLに含まれず）
- [x] ✅ 2026-06-09 Pydantic 型定義がすべてのリクエスト/レスポンスに存在すること
- [x] ✅ 2026-06-09 機密情報がコードに直書きされていないこと（SSM・IAMロール経由）
