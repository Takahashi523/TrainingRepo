    ...
    return (
        <div className="space-y-1.5 rounded-md border border-sky-200 bg-sky-50 px-3.5 py-3 text-[11px] leading-relaxed text-sky-900">
            ...
            <ul className="list-disc space-y-0.5 pl-4">
                ...
                <li>
                    <b>「バージョン（システム管理）」列は、システムが自動的に管理する値です。</b>
                    手動で編集・削除せず、エクスポートしたときの値のまま再インポートしてください（新規追加行では空欄のままで構いません。入力しても無視されます）。
                </li>
                <li>
                    <b>エクスポート後に対象の人材・案件が画面や別のCSVインポートで更新されていた場合、再インポート時に「バージョンが一致しません」というエラーになります。</b>
                    その場合、該当行を含むファイル全体は反映されません。対象を最新の状態で再度エクスポートしてから、あらためて編集・インポートしてください。
                </li>
            </ul>
        </div>
    );
